...
def parse_args():
    parser = argparse.ArgumentParser(description="Optimizer: A tool with simulator and agent plugin support.")
    ...
    parser.add_argument('-spl', '--simulator_plugin', type=str, default='default', help='Name of the simulator plugin to use.')
    parser.add_argument('-apl', '--agent_plugin', type=str, default='default', help='Name of the agent plugin to use.')
    ...
    parser.add_argument('-algo', '--algorithm', type=str, default='PPO', help='Algorithm to use (e.g., PPO, DQN).')
